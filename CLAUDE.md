# Working on Snake Classic

Serpent for Wear OS watches, in Kotlin and Jetpack Compose: the classic snake - steer,
eat the pellet, grow, and do not bite yourself or the wall. Everything runs on the
watch - no phone, no network, no account. `README.md` says what the app is; this file
is how work is done here. Longer procedures live in `.claude/skills/`.

## How the code is laid out

One Gradle module, `:wear`, under `com.dchernykh.serpent`:
...
| `SerpentViewModel.kt` | the hub between the rules and the screen |
